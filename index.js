...
function gantiStiker(index) {
  ...
  stikerElement.classList.remove("show");
  stikerElement.classList.add("hide");

  setTimeout(() => {
    stikerElement.src = stikerSrc;
    stikerElement.classList.remove("hide");
    stikerElement.classList.add("show");
  }, 300);
}
